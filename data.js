...
const SCHOOL_DATA = {
  ...
  // 近6年河南最低投档线（2020-2025），含2025年最新数据
  admissionLines: {
    science: {
      2025: { min: 352, max: 395, avg: 370 },
...
const MAJORS_DATA = {
  science: [
    {
      ...
      duration: 3, tuition: 4200, avgScore: 355, predictScore: 365,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 348, predictScore: 358,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 352, predictScore: 362,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 360, predictScore: 370,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 340, predictScore: 350,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 345, predictScore: 355,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 338, predictScore: 348,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 336, predictScore: 346,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 335, predictScore: 345,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 330, predictScore: 340,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 328, predictScore: 338,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 322, predictScore: 332,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 332, predictScore: 342,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 330, predictScore: 340,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 335, predictScore: 345,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 320, predictScore: 330,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 325, predictScore: 335,
    ...
    },
    {
      ...
      duration: 3, tuition: 4200, avgScore: 325, predictScore: 335,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 328, predictScore: 338,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 316, predictScore: 326,
    ...
    },
    {
      ...
      duration: 3, tuition: 3700, avgScore: 318, predictScore: 328,
  ...
  arts: [
    ...
    {
      id: 'marketing', name: '市场营销', category: 'finance', categoryName: '财经管理',
      duration: 3, tuition: 3700, avgScore: 322, predictScore: 332,
      description: '培养掌握市场营销理论和实务技能，具备市场调研、营销策划、品牌推广与销售管理能力。',
      courses: ['市场营销学','消费者心理学','市场调查与预测','品牌策划与管理','网络营销','商务谈判技巧','销售管理实务'],
      employmentRate: '89.2%',
      employmentDirections: ['市场营销专员','品牌策划','销售经理助理','新媒体运营','市场调研分析师'],
    ...
    {
      id: 'hotel-mgmt', name: '酒店管理与数字化运营', category: 'humanity', categoryName: '人文教育',
      duration: 3, tuition: 3700, avgScore: 315, predictScore: 325,
      description: '培养掌握酒店管理与数字化运营理论和技能，具备酒店前厅客房管理、餐饮服务及数字化营销能力。',
      courses: ['酒店管理概论','前厅客房服务与管理','餐饮服务与管理','酒店数字化营销','酒店人力资源管理','酒水知识与调酒','酒店英语口语'],
      employmentRate: '88.5%',
      employmentDirections: ['酒店前厅主管','客房部主管','餐饮部主管','酒店营销专员','会展策划专员'],
    ...
    {
      id: 'digital-media', name: '数字媒体技术', category: 'it', categoryName: '信息技术',
      duration: 3, tuition: 4200, avgScore: 326, predictScore: 336,
      description: '培养掌握数字媒体内容创作、影视后期制作、交互媒体设计等技术的高素质技术技能人才。',
      courses: ['平面设计基础','摄影与摄像技术','非线性编辑','三维建模与动画','影视后期特效','交互媒体设计','UI/UX设计'],
      employmentRate: '90.5%',
      employmentDirections: ['平面设计师','视频剪辑师','UI/UX设计师','三维建模师','新媒体运营'],
    ...
    {
      id: 'interior-design', name: '建筑室内设计', category: 'construction', categoryName: '建筑工程',
      duration: 3, tuition: 4200, avgScore: 320, predictScore: 330,
      description: '培养掌握室内设计基础理论和专业技能，具备室内方案设计、效果图表现与施工图绘制能力。',
      courses: ['设计素描与色彩','室内设计原理','CAD施工图绘制','3D Max效果图','室内装饰材料','软装设计','室内照明设计'],
      employmentRate: '89.8%',
      employmentDirections: ['室内设计师','效果图设计师','施工图绘图员','软装设计师','装修项目经理'],
...
// ========== 5年加权平均分计算 ==========
const YEAR_WEIGHTS = { 2025: 6, 2024: 5, 2023: 4, 2022: 3, 2021: 2, 2020: 1 };
...
function calcScoreBasedProb(score, avg, min) {
  let prob;
  if (score >= avg + 15) {
    prob = 90 + Math.min(10, Math.floor((score - avg - 15) / 3));
  } else if (score >= avg + 5) {
    prob = 70 + Math.floor((score - avg - 5) * 2);
  } else if (score >= avg - 10) {
    prob = 50 + Math.floor((score - avg + 10) * 2);
  } else if (score >= avg - 25) {
    prob = 25 + Math.floor((score - avg + 25) * 1.6);
  } else if (score >= avg - 40) {
    prob = 10 + Math.floor((score - avg + 40) * 1);
  } else {
    prob = Math.max(1, Math.floor((score - min + 40) * 0.3));
  }
  return Math.max(0, Math.min(99, prob));
}

function calcRankBasedProb(userRank, targetRank) {
  // diff = targetRank - userRank  => 正数 = 用户排名更高
  const diff = targetRank - userRank;
  let prob;
  if (diff >= 10000) {
    prob = 90 + Math.min(10, Math.floor((diff - 10000) / 3000));
  } else if (diff >= 3000) {
    prob = 70 + Math.floor((diff - 3000) / 700 * 2);
  } else if (diff >= -3000) {
    prob = 50 + Math.floor((diff + 3000) / 6000 * 20);
  } else if (diff >= -10000) {
    prob = 25 + Math.floor((diff + 10000) / 7000 * 25);
  } else if (diff >= -20000) {
    prob = 8 + Math.floor((diff + 20000) / 10000 * 17);
  } else {
    prob = Math.max(1, Math.floor((diff + 30000) / 10000 * 3));
  }
  return Math.max(0, Math.min(99, prob));
}

function getLevel(prob) {
  if (prob >= 85) return '保底';       // 保底
  if (prob >= 60) return '稳妥';       // 稳妥
  if (prob >= 30) return '冲刺';       // 冲刺
  return '风险较大';           // 风险较大
}
...
function calcAdmitProbability(score, major, schoolData, subject) {
  ...
  return {
    schoolProb, schoolLevel: getLevel(schoolProb),
    majorProb, majorLevel: getLevel(majorProb)
  };
}
...
const RANK_TABLE = {
  science: {
    // 分数 → 排名 (理科)
    points: [200, 220, 240, 260, 280, 300, 310, 320, 330, 340, 350, 360, 370, 380, 390, 400, 420, 440, 460],
    ranks:  [490000, 480000, 466000, 448000, 425000, 398000, 382000, 365000, 346000, 325000, 302000, 278000, 252000, 228000, 204000, 180000, 135000, 100000, 72000]
  },
  arts: {
    points: [200, 220, 240, 260, 280, 290, 300, 310, 320, 330, 340, 350, 360, 370, 380, 400, 420, 440],
    ranks:  [328000, 318000, 305000, 288000, 268000, 256000, 242000, 226000, 209000, 190000, 172000, 154000, 136000, 118000, 100000, 73000, 52000, 36000]
  }
};
